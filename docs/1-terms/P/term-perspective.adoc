...
<<ref-rozanski-2011,Rozanski+11>> associates with the term _perspective_ also activities, tactics, and guidelines that must be considered if a system should provide a set of related quality properties and suggests the following perspectives:
...
<<ref-rozanski-2011,Rozanski+11>> verbindet mit dem Begriff *Perspektive* auch
