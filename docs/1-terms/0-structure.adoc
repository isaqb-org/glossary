...
include::A/0-structure.adoc[{include_configuration}]
include::B/0-structure.adoc[{include_configuration}]
include::C/0-structure.adoc[{include_configuration}]
include::D/0-structure.adoc[{include_configuration}]
include::E/0-structure.adoc[{include_configuration}]
include::F/0-structure.adoc[{include_configuration}]
include::G/0-structure.adoc[{include_configuration}]
include::H/0-structure.adoc[{include_configuration}]
include::I/0-structure.adoc[{include_configuration}]
...
include::Q/0-structure.adoc[{include_configuration}]
...
include::V/0-structure.adoc[{include_configuration}]
include::W/0-structure.adoc[{include_configuration}]
