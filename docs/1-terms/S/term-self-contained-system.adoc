...
An architectural pattern, similar to <<term-microservice,microservices>>. To quote from the site
...
konzentriert, sodass das vollständige System eine Zusammenarbeit
