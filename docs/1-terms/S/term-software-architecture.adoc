...
called <<term-cross-cutting-concept,crosss-cutting concepts>> or even _solution patterns_. Principles (concepts) are the foundation for <<term-conceptual-integrity,conceptual integrity>>.
...
<<term-cross-cutting-concept,Querschnittskonzepte>> oder sogar _Lösungsmuster_ genannt. Prinzipien (Konzepte)
